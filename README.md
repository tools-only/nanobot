...
- **2026-04-11** 🚀 Released **v0.1.4.post7** — knowledge is now domain-aware at the low level (`finance`, `paper`, `agent`, etc.), vault paths are organized by domain, and high-level synthesis retains domain and cross-domain bridge metadata. See [release notes](docs/releases/v0.1.4.post7.md).
